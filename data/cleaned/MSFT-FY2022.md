...
edgar_url: https://www.sec.gov/Archives/edgar/data/789019/000156459022026876/msft-10k_20220630.htm
stats_items_kept: ["1", "1A", "2", "3", "5", "7", "7A", "8", "9A"]
stats_items_dropped: ["1B", "4", "6", "9", "9B", "9C", "10", "11", "12", "13", "14", "15", "16"]
stats_tables_kept: 88
stats_subheadings_kept: 129
stats_chars_clean: 274879
---
...
**Table: Our executive officers as of July 28, 2022 were as follows:**
| Name | — | — |
|---|---|---|
...
**Table: Following are our monthly share repurchases for the fourth quarter of fiscal year 2022:**
| Period | Total Number of Shares Purchased | — | — | Approximate Dollar Value of Shares That May Yet Be Purchased Under the Plans or Programs | — |
|---|---|---|---|---|---|
| — | (In millions) | — | — | — | — |
...
**Table: Our Board of Directors declared the following dividends during the fourth quarter of fiscal year 2022:**
...
**Table: The components of other income (expense), net were as follows:**
| (In millions) | — | — |
|---|---|---|
...
**Table: The following table reconciles our financial results reported in accordance with GAAP to non-GAAP financial results:**
...
**Table: The following table outlines the expected future recognition of unearned revenue as of June 30, 2022:**
| (In millions) | — |
|---|---|
| Three Months Ending | — |
...
**Table: COMPREHENSIVE INCOME STATEMENTS**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
| Net income | $ | 72,738 | — | 61,271 | — | 44,281 |
...
**Table: STOCKHOLDERS’ EQUITY STATEMENTS**
| (In millions, except per share amounts) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
...
**Table: Activity in the allowance for doubtful accounts was as follows:**
| (In millions) | — | — | — |
|---|---|---|---|
| Year Ended June 30, | 2022 | 2021 | 2020 |
...
**Table: Allowance for doubtful accounts included in our consolidated balance sheets:**
| (In millions) | — | — | — |
|---|---|---|---|
...
**Table: The components of basic and diluted EPS were as follows:**
...
**Table: Net recognized gains (losses) on debt investments were as follows:**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
...
**Table: Net recognized gains (losses) on equity investments were as follows:**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
...
**Table: The components of investments were as follows:**
| (In millions) | — | — | Unrealized Losses | — | Short-term Investments | — | — | — |
|---|---|---|---|---|---|---|---|---|
| June 30, 2022 | — | — | — | — | — | — | — | — |
...
**Table: Unrealized Losses on Debt Investments**
...
**Table: Debt Investment Maturities**
| (In millions) | — | — |
|---|---|---|
| June 30, 2022 | — | — |
...
**Table: Credit-Risk-Related Contingent Features**
| (In millions) | — | — |
|---|---|---|
...
**Table: The following table presents our derivative instruments:**
...
**Table: The following table presents the fair value of our derivatives instruments on a gross basis:**
| (In millions) | — | — | — | — |
|---|---|---|---|---|
| June 30, 2022 | — | — | — | — |
...
**Table: Gains (losses) on derivative instruments recognized in other income (expense), net were as follows:**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
...
**Table: The components of inventories were as follows:**
| (In millions) | — | — | — | — |
|---|---|---|---|---|
| June 30, | 2022 | — | 2021 | — |
...
**Table: The components of property and equipment were as follows:**
| (In millions) | — | — | — | — |
|---|---|---|---|---|
| June 30, | 2022 | — | 2021 | — |
| Land | $ | 4,734 | — | 3,660 |
...
**Table: The major classes of assets and liabilities to which we have preliminarily allocated the purchase price were as follows:**
| (In millions) | — |
|---|---|
| Goodwill (a) | 16,308 |
...
**Table: Following are the details of the purchase price allocated to the intangible assets acquired:**
...
**Table: Following are details of the purchase price allocated to the intangible assets acquired:**
| (In millions, except average life) | — | — |
|---|---|---|
...
**Table: Changes in the carrying amount of goodwill were as follows:**
...
**Table: The components of intangible assets, all of which are finite-lived, were as follows:**
| (In millions) | — | — | — | Net Carrying Amount | Gross Carrying Amount | — | — | Net Carrying Amount | — | — |
|---|---|---|---|---|---|---|---|---|---|---|
| June 30, | — | — | — | 2022 | — | — | — | 2021 | — | — |
...
**Table: The components of intangible assets acquired during the periods presented were as follows:**
| (In millions) | Amount | — | — | Amount | Weighted Average Life | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | — | 2021 | — | — |
...
**Table: The components of debt were as follows:**
| (In millions, issuance by calendar year) | — | Stated Interest Rate | — | — | June 30, 2022 | — | — | — | — | — | — | — |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
**Table: The following table outlines maturities of our long-term debt, including the current portion, as of June 30, 2022:**
| (In millions) | — |
|---|---|
| Year Ending June 30, | — |
| 2023 | 2,750 |
...
**Table: The components of the provision for income taxes were as follows:**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
| Current Taxes | — | — | — | — | — | — |
...
**Table: U.S. and foreign components of income before income taxes were as follows:**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
...
**Table: The components of the deferred income tax assets and liabilities were as follows:**
| (In millions) | — | — | — | — |
|---|---|---|---|---|
| June 30, | 2022 | — | 2021 | — |
...
**Table: The aggregate changes in the gross unrecognized tax benefits related to uncertain tax positions were as follows:**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
...
**Table: Unearned revenue by segment was as follows:**
| (In millions) | — | — | — | — |
|---|---|---|---|---|
| June 30, | 2022 | — | 2021 | — |
...
**Table: Changes in unearned revenue were as follows:**
| (In millions) | — |
|---|---|
...
**Table: The components of lease expense were as follows:**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
...
**Table: Supplemental cash flow information related to leases was as follows:**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
...
**Table: Supplemental balance sheet information related to leases was as follows:**
...
**Table: The following table outlines maturities of our lease liabilities as of June 30, 2022:**
| (In millions) | — | — | — | — |
|---|---|---|---|---|
...
**Table: Shares of common stock outstanding were as follows:**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
...
**Table: We repurchased the following shares of common stock under the share repurchase programs:**
...
**Table: Our Board of Directors declared the following dividends:**
...
**Table: The following table summarizes the changes in accumulated other comprehensive income (loss) by component :**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
| Derivatives | — | — | — | — | — | — |
...
**Table: Stock-based compensation expense and related income tax benefits were as follows:**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
| Stock-based compensation expense | $ | 7,502 | — | 6,118 | — | 5,289 |
...
**Table: The fair value of stock awards was estimated on the date of grant using the following assumptions:**
| Year ended June 30, | — | — | 2022 | — | — | 2021 | — | — | 2020 |
|---|---|---|---|---|---|---|---|---|---|
...
**Table: During fiscal year 2022, the following activity occurred under our stock plans:**
...
**Table: Employees purchased the following shares during the periods presented:**
| (Shares in millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
...
**Table: Productivity and Business Processes**
...
**Table: Segment revenue and operating income were as follows during the periods presented:**
| (In millions) | — | — | — |
|---|---|---|---|
| Year Ended June 30, | 2022 | 2021 | 2020 |
| Revenue | — | — | — |
...
**Table: Revenue, classified by significant product and service offerings, was as follows:**
| (In millions) | — | — | — | — | — | — |
|---|---|---|---|---|---|---|
| Year Ended June 30, | 2022 | — | 2021 | — | 2020 | — |
